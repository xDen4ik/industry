		...
		<div class="container">
			<div class="row slider-text align-items-center justify-content-center">
				<div class="col-md-8 text-center col-sm-12 element-animate pt-5">
					<h1 class="pt-5"><span>Обратная связь</span></h1>
					<p class="mb-5 w-75">Оставьте сообщение и мы свяжемся с Вами</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6 mb-5 order-2">
				<form action="#" method="post">
					...
					<div class="row">
						<div class="col-md-6 form-group">
							<input type="submit" value="Отправить" class="btn btn-primary px-3 py-3">
						</div>
					</div>
				</form>
			</div>
				...
				<div class="row justify-content-right">
					<div class="col-md-8 mx-auto contact-form-contact-info">
						...
						<p class="d-flex">
							...
							<span>+7(949)-330-25-22</span>
						</p>

						<p class="d-flex">
							<span class="ion-android-mail icon mr-5"></span>
							<span>pt.da@yandex.ru</span>
						</p>
					</div>
				</div>
			</div>
